...
//
// Related Topics 哈希表 链表 双指针 👍 2058 👎 0
...
class intersectionOfTwoLinkedLists{
    ...
    public static void main(String[] args) {
        ...
        ListNode linkedList = CreateLink.createLinkedList(new int[]{4, 1, 8, 4, 5});
        ListNode linkedList1 = CreateLink.createLinkedList(new int[]{5, 6, 1, 8, 4, 5});
        ListNode intersectionNode = solution.getIntersectionNode(linkedList, linkedList1);
        PrintLink.printLinkedList(intersectionNode);
    }
